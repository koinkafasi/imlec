...
impl Shape {
    ...
    pub fn vertices(self, cx: f32, cy: f32, size: f32, rotation: f32) -> Verts {
        ...
        let len = match self {
            Shape::Circle => regular(&mut points, cx, cy, r, 12, rotation, -std::f32::consts::FRAC_PI_2),
            Shape::Square => regular(&mut points, cx, cy, r * std::f32::consts::SQRT_2, 4, rotation, std::f32::consts::FRAC_PI_4),
            Shape::Triangle => regular(&mut points, cx, cy, r, 3, rotation, -std::f32::consts::FRAC_PI_2),
            Shape::Diamond => regular(&mut points, cx, cy, r, 4, rotation, -std::f32::consts::FRAC_PI_2),
